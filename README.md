...
Alternative: `git` users can clone [HubSpot/oauth-quickstart-python](https://github.com/HubSpot/oauth-quickstart-python), then create a `.env` file to store `CLIENT_ID` and `CLIENT_SECRET`.
